  ...
  return (
    <main className="bg-milk-bio text-moss-shadow font-sans">
      ...
      <section className="max-w-3xl mx-auto py-16 px-6 space-y-8">
        ...
        <p className="text-lg leading-relaxed">
          Our work blends curiosity with cleanliness: simple kits, clear guides,
          and a belief that anyone can grow something incredible with just a bit
          of care. Every medium we mix, every culture jar we ship, and every
          guide we write comes from that partnership between science and soil.
        </p>
      </section>
      ...
      <section className="bg-spore-grey/30 py-16 px-6">
        <div className="max-w-3xl mx-auto space-y-6 text-center">
          ...
          <p className="text-base leading-relaxed">
            ...
            science approachable, we hope to grow a new culture: one that values
            nature, curiosity, and care.
          </p>
          <p className="text-base leading-relaxed">
            We&apos;re not a big company. We&apos;re a family business, working
            in Korea, trying to make sustainable propagation tools that are as
            clean and thoughtful as the plants they grow.
          </p>
        </div>
      </section>
