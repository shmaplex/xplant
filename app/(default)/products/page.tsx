    ...
    <main className="flex-1 max-w-7xl mx-auto px-6 py-20">
      <div className="flex flex-col space-y-4 items-center justify-center mb-12">
        ...
        <p className="max-w-3xl text-center text-moss-shadow leading-relaxed text-lg px-4 sm:px-0">
          Our mission is to replace synthetic agricultural and lab products with
          natural, organic alternatives that promote healthier, more sustainable
          plant growth. Each product below has been carefully crafted to offer
          superior performance while aligning with our commitment to
