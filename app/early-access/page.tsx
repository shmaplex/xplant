      ...
      <main className="flex-1 w-full flex items-center justify-center px-6 py-16">
        <div className="max-w-2xl w-full space-y-10 text-center">
          ...
          <p className="text-moss-shadow text-base sm:text-lg leading-relaxed">
            We&rsquo;re building a new way to grow&mdash;small‑scale,
            sustainable tissue culture kits and resources that put plant
            propagation back in the hands of growers.
            <br />
            <br />
            We appreciate you being early! By joining below, you&rsquo;ll
            receive updates, behind‑the‑scenes progress, and first access to our
            kits as soon as they&rsquo;re ready.
          </p>
