      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 sm:px-10 py-12 space-y-16">
        <header className="text-left">
          ...
          <p className="text-lg sm:text-xl text-[#4A4A4A]">
            Discover natural, sustainable alternatives to synthetic media such
            as Murashige &amp; Skoog (MS). Organic culture mediums aim to work
            with nature&mdash;not against it.
          </p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <li>
              Encouraging slower, stronger growth rather than rapid forcing
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>
              <strong>Natural sugars:</strong> Unrefined cane sugar or honey as
              an energy source.
            </li>
            <li>
          ...
          <p className="text-sm text-gray-600">
            ...
            contamination, and recipes may need fine&ndash;tuning for
            consistency.
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            Working with organic components means greater variability in
            nutrients and slower growth compared to synthetic MS medium. The
            trade&ndash;off is healthier plantlets and a reduced ecological
            footprint. Many researchers and hobbyists are experimenting with
            blends that balance the best of both approaches.
          </p>
        </section>
