      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 sm:px-10 py-12 space-y-16">
        ...
        <header className="text-left">
          ...
          <p className="text-lg sm:text-xl text-[#4A4A4A]">
            A practical, beginner-friendly way to start your plant tissue
            culture journey. These kits come with everything you need—no lab
            required.
          </p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>Pre‑mixed organic culture medium (sealed jars)</li>
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <li>
              Perfect for learning the basics before mixing your own media
            </li>
          </ul>
        </section>
