...
export function GuideCTA({
  ...
  return (
    <section className="bg-gradient-to-tr from-milk-bio via-psybeam-purple/20 to-spore-grey/20 rounded-2xl p-10 mx-auto text-center shadow-lg border border-psybeam-purple/30">
