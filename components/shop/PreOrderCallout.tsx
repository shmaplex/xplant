...
export default function PreOrderCallout() {
  return (
    <div className="max-w-full mx-auto mb-8 px-4">
      <div className="bg-[var(--milk-bio)] border border-[var(--moss-shadow)] rounded-xl p-4 sm:p-5 shadow-md relative overflow-hidden">
        <div
          className="absolute inset-0 bg-gradient-to-br
            from-[var(--future-lime)]/10
            via-[var(--psybeam-purple)]/10
            to-[var(--future-lime)]/10
            pointer-events-none rounded-xl"
        />
        <h3 className="text-sm sm:text-base font-semibold text-[var(--moss-shadow)] relative z-10">
          🌱 Pre-Order Notice
        </h3>
