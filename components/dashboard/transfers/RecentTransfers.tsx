...
export default function RecentTransfers({ transfers }: RecentTransfersProps) {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-10 py-8 bg-white rounded-2xl shadow-sm border border-spore-grey/10 mb-12">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          ...
          className="text-future-lime font-semibold hover:underline focus:outline-none focus:ring-2 focus:ring-future-lime rounded text-sm"
          ...
          {transfers.map((t) => (
            <li key={t.id}>
              <Link
                ...
                className="block px-4 py-3 hover:bg-future-lime/10 focus:outline-none focus:ring-2 focus:ring-future-lime rounded transition-colors"
              >
                <div className="flex justify-between items-center">
                  ...
                  <svg
                    className="w-5 h-5 text-future-lime"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth={2}
                    viewBox="0 0 24 24"
